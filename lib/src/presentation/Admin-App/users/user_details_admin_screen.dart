...
import 'package:wassit_cars_rental_app/src/presentation/Users-App/profile/profile_screen.dart';
...
class UserDetailsAdminScreen extends StatefulWidget {
  ...
  @override
  State<UserDetailsAdminScreen> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<UserDetailsAdminScreen> {
  @override
  ...
  Material _profileElement({
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
            height: 80.h,
            width: (context.width.w - 20.w - 40.w) / 2,
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10.r),
            ),
            child: Center(
